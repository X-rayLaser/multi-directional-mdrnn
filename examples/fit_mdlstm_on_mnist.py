...
def fit_mdlstm(target_image_size=10, rnn_units=128, epochs=30, batch_size=32):
    # get MNIST examples
    ...
    # create multi-directional MDLSTM layer
    rnn = MultiDirectional(MDLSTM(units=rnn_units, input_shape=[target_image_size, target_image_size, 1]))
